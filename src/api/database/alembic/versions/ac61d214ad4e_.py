...
def upgrade() -> None:
    ...
    sa.Column('curso', sa.Enum('MESTRADO', 'DOUTORADO', name='cursoalunoenum'), nullable=False),
    ...
    sa.Column('titulo', sa.Enum('COORDENADOR', 'PROFESSOR', 'ALUNO', name='tipousuarioenum'), nullable=False),
    sa.Column('descricao', sa.String(length=255), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_tipo_usuario_descricao'), 'tipo_usuario', ['descricao'], unique=False)
    op.create_index(op.f('ix_tipo_usuario_id'), 'tipo_usuario', ['id'], unique=False)
    op.create_index(op.f('ix_tipo_usuario_titulo'), 'tipo_usuario', ['titulo'], unique=False)
    op.create_table('usuarios',
    sa.Column('nome', sa.String(length=255), nullable=False),
    sa.Column('email', sa.String(length=255), nullable=False),
    sa.Column('senha_hash', sa.String(length=255), nullable=False),
    sa.Column('token_nova_senha', sa.String(length=255), nullable=True),
    ...
    op.create_index(op.f('ix_usuarios_senha_hash'), 'usuarios', ['senha_hash'], unique=False)
    op.create_index(op.f('ix_usuarios_tipo_usuario_id'), 'usuarios', ['tipo_usuario_id'], unique=False)
    ...
    op.create_index(op.f('ix_professores_usuario_id'), 'professores', ['usuario_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['orientador_id'], ['professores.id'], ),
    sa.ForeignKeyConstraint(['usuario_id'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('PENDENTE', 'ACEITA', 'RECUSADA', name='statussolicitacaoenum'), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_solicitacoes_professor_id'), 'solicitacoes', ['professor_id'], unique=False)
    op.create_index(op.f('ix_solicitacoes_status'), 'solicitacoes', ['status'], unique=False)
    op.create_table('tarefas',
    sa.Column('nome', sa.String(length=255), nullable=False),
    sa.Column('descricao', sa.String(length=255), nullable=False),
    sa.Column('data_ultima_notificacao', sa.DateTime(), nullable=False),
